...
2. Upload the `quoteframeshare` folder to `/wp-content/plugins/` or install the plugin 'QuoteFrameShare' through the WordPress plugins screen directly.
3. Activate via WordPress admin.
4. Add the Quote Frame Share block in Gutenberg.
...
= 3.2.0 =
Fixes "Attempt Block Recovery" issue and improves styling, structure, and frontend script handling.

= 2.1.8 =
More customization, X (Twitter) icon, improved icons, copy alert.
